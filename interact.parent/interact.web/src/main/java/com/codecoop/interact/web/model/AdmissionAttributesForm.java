...
@Component
public class AdmissionAttributesForm {
	...
	@NotEmpty(message="should have value")
	...
	private Boolean HRC_OR_TI_GI_1_5_2_5;// BOOLEAN		// commented enable by RAMESH and rename "." as "_"
	...
	private Boolean HRC_OR_TI_OP;// VARCHAR				// needed check box here as for form available String changed to boolean
	...
	private Boolean NCPSF_C_RFC_R;// VARCHAR			needed Boolean as per pdf doc, String modified as Boolean
	...
	private String NCPSF_N_AND_H_D;// BOOLEAN				needed String as per pdf doc,Boolean modified as String by RAMESH
	...
	private Boolean NCPSF_N_AND_H_TF_DI;// VARCHAR			need Boolean as per pdf doc, String modified as Boolean by RAMESH
	...
	private String NCPSF_N_AND_H_TF_TFP_T;// BOOLEAN					need String as per pdf doc, Boolean modified as String by RAMESH
	private String NCPSF_N_AND_H_TF_TFP_RTE_CC_PER_H;// VARCHAR			need String as per pdf doc, Boolean modified as String by RAMESH
	private String NCPSF_N_AND_H_TF_TFP_EVERY_H_OR_DAY;// BOOLEAN		need String as per pdf doc, Boolean modified as String by RAMESH
	...
	private String NCPSF_SC_PU_STAGE;// BOOLEAN							need String as per pdf doc, Boolean modified as String by RAMESH
	private String NCPSF_SC_PU_LOCATION;// BOOLEAN						need String as per pdf doc, Boolean modified as String by RAMESH
	private Boolean NCPSF_SC_SPU;// BOOLEAN
	private String NCPSF_SC_SPU_STAGE;// BOOLEAN
	private String NCPSF_SC_SPU_LOCATION;// BOOLEAN						need String as per pdf doc, Boolean modified as String by RAMESH
	private Boolean NCPSF_SC_OTHR;// BOOLEAN
	private String NCPSF_SC_OTHR_SPCFY;// VARCHAR
	// NCPSF_R&P_FALL BOOLEAN
	private Boolean NCPSF_R_AND_P_FALL;	//BOOLEAN						not available Created by RAMESH
...
// created by RAMESH
	private Boolean MADAN_ADM_HP;
	private Boolean MADAN_SP_CNS;
	private Boolean MADAN_MED_RC;
	private Boolean MADAN_OP_REP;
	private Boolean MADAN_DIAG_STUD;
	private Boolean MADAN_LABS;
	private Boolean MADAN_DIB_GLU_VAL;
	private Boolean MADAN_PIC_PLS_CONF;
	private Boolean MADAN_REB_THY_NOTS;
	private Boolean MADAN_REPO_THY_NOTS;
	private Boolean MADAN_NUT_NOTS;
	private Boolean MADAN_PAIN_RAT;
	private Boolean MADAN_CDE_STS;
	private Boolean MADAN_AD_DIR;
	private Boolean MADAN_DIS_SUM;
	
	private List<MedicalReconciliationDto> medicalReconciliationDto;
	
// END : created by RAMESH
	// END : Admission Attributes Table
	
	public AdmissionAttributesForm() {
	}
//	
//	public AdmissionAttributesForm(String facilityName,String faciliyTelNo) {
//		this.transferredToPostAcuteCare = facilityName;
//		this.postAcuteCareTelephoneNumber = faciliyTelNo;
//	}
	...
	public void setHRC_OR_TI_OP__I_IHP_AND_CBD(Boolean hRC_OR_TI_OP__I_IHP_AND_CBD) {
	...
	public void setNCPSF_N_AND_H_TF_DI_FWB_HRS(String nCPSF_N_AND_H_TF_DI_FWB_HRS) {
	...
	public Boolean getMADAN_ADM_HP() {
		return MADAN_ADM_HP;
	}
	public void setMADAN_ADM_HP(Boolean mADAN_ADM_HP) {
		MADAN_ADM_HP = mADAN_ADM_HP;
	}
	public Boolean getMADAN_SP_CNS() {
		return MADAN_SP_CNS;
	}
	public void setMADAN_SP_CNS(Boolean mADAN_SP_CNS) {
		MADAN_SP_CNS = mADAN_SP_CNS;
	}
	public Boolean getMADAN_MED_RC() {
		return MADAN_MED_RC;
	}
	public void setMADAN_MED_RC(Boolean mADAN_MED_RC) {
		MADAN_MED_RC = mADAN_MED_RC;
	}
	public Boolean getMADAN_OP_REP() {
		return MADAN_OP_REP;
	}
	public void setMADAN_OP_REP(Boolean mADAN_OP_REP) {
		MADAN_OP_REP = mADAN_OP_REP;
	}
	public Boolean getMADAN_DIAG_STUD() {
		return MADAN_DIAG_STUD;
	}
	public void setMADAN_DIAG_STUD(Boolean mADAN_DIAG_STUD) {
		MADAN_DIAG_STUD = mADAN_DIAG_STUD;
	}
	public Boolean getMADAN_LABS() {
		return MADAN_LABS;
	}
	public void setMADAN_LABS(Boolean mADAN_LABS) {
		MADAN_LABS = mADAN_LABS;
	}
	public Boolean getMADAN_DIB_GLU_VAL() {
		return MADAN_DIB_GLU_VAL;
	}
	public void setMADAN_DIB_GLU_VAL(Boolean mADAN_DIB_GLU_VAL) {
		MADAN_DIB_GLU_VAL = mADAN_DIB_GLU_VAL;
	}
	public Boolean getMADAN_PIC_PLS_CONF() {
		return MADAN_PIC_PLS_CONF;
	}
	public void setMADAN_PIC_PLS_CONF(Boolean mADAN_PIC_PLS_CONF) {
		MADAN_PIC_PLS_CONF = mADAN_PIC_PLS_CONF;
	}
	public Boolean getMADAN_REB_THY_NOTS() {
		return MADAN_REB_THY_NOTS;
	}
	public void setMADAN_REB_THY_NOTS(Boolean mADAN_REB_THY_NOTS) {
		MADAN_REB_THY_NOTS = mADAN_REB_THY_NOTS;
	}
	public Boolean getMADAN_REPO_THY_NOTS() {
		return MADAN_REPO_THY_NOTS;
	}
	public void setMADAN_REPO_THY_NOTS(Boolean mADAN_REPO_THY_NOTS) {
		MADAN_REPO_THY_NOTS = mADAN_REPO_THY_NOTS;
	}
	public Boolean getMADAN_NUT_NOTS() {
		return MADAN_NUT_NOTS;
	}
	public void setMADAN_NUT_NOTS(Boolean mADAN_NUT_NOTS) {
		MADAN_NUT_NOTS = mADAN_NUT_NOTS;
	}
	public Boolean getMADAN_PAIN_RAT() {
		return MADAN_PAIN_RAT;
	}
	public void setMADAN_PAIN_RAT(Boolean mADAN_PAIN_RAT) {
		MADAN_PAIN_RAT = mADAN_PAIN_RAT;
	}
	public Boolean getMADAN_CDE_STS() {
		return MADAN_CDE_STS;
	}
	public void setMADAN_CDE_STS(Boolean mADAN_CDE_STS) {
		MADAN_CDE_STS = mADAN_CDE_STS;
	}
	public Boolean getMADAN_AD_DIR() {
		return MADAN_AD_DIR;
	}
	public void setMADAN_AD_DIR(Boolean mADAN_AD_DIR) {
		MADAN_AD_DIR = mADAN_AD_DIR;
	}
	public Boolean getMADAN_DIS_SUM() {
		return MADAN_DIS_SUM;
	}
	public void setMADAN_DIS_SUM(Boolean mADAN_DIS_SUM) {
		MADAN_DIS_SUM = mADAN_DIS_SUM;
	}
	...
	public String toString() {
		return "AdmissionAttributesForm [patientName=" + patientName + ", dob="
				+ dob + ", patientGender=" + patientGender
				+ ", canSpeakEnglish=" + canSpeakEnglish + ", otherLanguage="
				+ otherLanguage + ", ethnicityType=" + ethnicityType
				+ ", otherEthnicityType=" + otherEthnicityType
				...
				+ ", patientId=" + patientId + ", admittedByStaffId="
				+ admittedByStaffId + ", admittedByStaffName="
				+ admittedByStaffName + ", admittedByStaffType="
				+ admittedByStaffType + ", patientEpisodeId="
				...
				+ ", specialist1SpecialityId=" + specialist1SpecialityId
				...
				+ specialist2Speciality + ", specialist2SpecialityId="
				+ specialist2SpecialityId + ", specialist2TelephoneNumber="
				...
				+ ", KCIVS_PAIN_RATING=" + KCIVS_PAIN_RATING
				+ ", KCIVS_NOT_APPLICABLE=" + KCIVS_NOT_APPLICABLE
				+ ", KCIVS_PAIN_SITE=" + KCIVS_PAIN_SITE + ", KCIVS_TEMP="
				+ KCIVS_TEMP + ", KCIVS_BP=" + KCIVS_BP + ", KCIVS_HR="
				+ KCIVS_HR + ", KCIVS_RR=" + KCIVS_RR + ", KCIVS_02SAT="
				+ KCIVS_02SAT + ", KCIVS_WGHT=" + KCIVS_WGHT + ", KCIMS_ALRT="
				+ KCIMS_ALRT + ", KCIMS_DFC=" + KCIMS_DFC + ", KCIMS_DCFC="
				+ KCIMS_DCFC + ", KCIMS_N_ALRT=" + KCIMS_N_ALRT + ", KCID_PDD="
				+ KCID_PDD + ", KCID_OMD=" + KCID_OMD + ", KCID_MHD="
				+ KCID_MHD + ", HRC_OR_TI_FALRSK=" + HRC_OR_TI_FALRSK
				+ ", HRC_OR_TI_PREC=" + HRC_OR_TI_PREC + ", HRC_OR_TI_HF="
				+ HRC_OR_TI_HF + ", HRC_OR_TI_HF_NEWDIAG="
				+ HRC_OR_TI_HF_NEWDIAG + ", HRC_OR_TI_HF_EXTHADMSSION="
				+ HRC_OR_TI_HF_EXTHADMSSION
				+ ", HRC_OR_TI_HF_EXTHADMSSION_LSTDTE="
				+ HRC_OR_TI_HF_EXTHADMSSION_LSTDTE + ", HRC_OR_TI_HF_EF="
				+ HRC_OR_TI_HF_EF + ", HRC_OR_TI_HF_EFP=" + HRC_OR_TI_HF_EFP
				+ ", HRC_OR_TI_HF_EF_DW=" + HRC_OR_TI_HF_EF_DW
				+ ", HRC_OR_TI_AC=" + HRC_OR_TI_AC + ", HRC_OR_TI_AC_REASON="
				+ HRC_OR_TI_AC_REASON + ", HRC_OR_TI_AC_R_AFIB="
				+ HRC_OR_TI_AC_R_AFIB + ", HRC_OR_TI_AC_R_DVT_OR_PE="
				+ HRC_OR_TI_AC_R_DVT_OR_PE + ", HRC_OR_TI_AC_R_MECVAL="
				+ HRC_OR_TI_AC_R_MECVAL + ", HRC_OR_TI_AC_R_POP="
				+ HRC_OR_TI_AC_R_POP + ", HRC_OR_TI_AC_R_LOWEF="
				+ HRC_OR_TI_AC_R_LOWEF + ", HRC_OR_TI_AC_R_OTHR="
				+ HRC_OR_TI_AC_R_OTHR + ", HRC_OR_TI_AC_R_OTHR_TEXT="
				+ HRC_OR_TI_AC_R_OTHR_TEXT + ", HRC_OR_TI_AC_R_DURTN="
				+ HRC_OR_TI_AC_R_DURTN + ", HRC_OR_TI_GI_1_5_2_5="
				+ HRC_OR_TI_GI_1_5_2_5 + ", HRC_OR_TI_GI_2_3="
				+ HRC_OR_TI_GI_2_3 + ", HRC_OR_TI_GI_OTHR=" + HRC_OR_TI_GI_OTHR
				+ ", HRC_OR_TI_GI_OTHR_TEXT=" + HRC_OR_TI_GI_OTHR_TEXT
				+ ", HRC_OR_TI_OP=" + HRC_OR_TI_OP + ", HRC_OR_TI_OP_INDCTN="
				+ HRC_OR_TI_OP_INDCTN + ", HRC_OR_TI_OP__I_IHP_AND_CBD="
				+ HRC_OR_TI_OP__I_IHP_AND_CBD + ", HRC_OR_TI_OP_SD="
				+ HRC_OR_TI_OP_SD + ", HRC_OR_TI_OP_SD_TEXT="
				+ HRC_OR_TI_OP_SD_TEXT + ", HRC_OR_TI_OAB=" + HRC_OR_TI_OAB
				+ ", HRC_OR_TI_OAB_INDCTN=" + HRC_OR_TI_OAB_INDCTN
				+ ", HRC_OR_TI_OAB_TTCD=" + HRC_OR_TI_OAB_TTCD
				+ ", HRC_OR_TI_OAB_DS=" + HRC_OR_TI_OAB_DS + ", HRC_OR_TI_D="
				+ HRC_OR_TI_D + ", HRC_OR_TI_D_MRGD=" + HRC_OR_TI_D_MRGD
				+ ", HRC_OR_TI_D_MRGT=" + HRC_OR_TI_D_MRGT + ", M_AND_A_MLA="
				+ M_AND_A_MLA + ", M_AND_A_ALLRGS_NK=" + M_AND_A_ALLRGS_NK
				+ ", M_AND_A_ALLRGS_Y=" + M_AND_A_ALLRGS_Y
				+ ", M_AND_A_ALLRGS_Y_SPCFY=" + M_AND_A_ALLRGS_Y_SPCFY
				+ ", M_AND_A_PM_N=" + M_AND_A_PM_N + ", M_AND_A_PM_Y="
				+ M_AND_A_PM_Y + ", M_AND_A_PM_SPCFY=" + M_AND_A_PM_SPCFY
				+ ", M_AND_A_PM_D=" + M_AND_A_PM_D + ", M_AND_A_PM_LD="
				+ M_AND_A_PM_LD + ", NCPSF_AMBLTN_INDPNDNT="
				+ NCPSF_AMBLTN_INDPNDNT + ", NCPSF_AMBLTN_WA="
				+ NCPSF_AMBLTN_WA + ", NCPSF_AMBLTN_WAD=" + NCPSF_AMBLTN_WAD
				+ ", NCPSF_AMBLTN_NTA=" + NCPSF_AMBLTN_NTA + ", NCPSF_WB_FULL="
				+ NCPSF_WB_FULL + ", NCPSF_WB_PARTL_L_OR_R="
				+ NCPSF_WB_PARTL_L_OR_R + ", NCPSF_WB_NONE=" + NCPSF_WB_NONE
				+ ", NCPSF_TRNSFR_SLF=" + NCPSF_TRNSFR_SLF
				+ ", NCPSF_TRNSFR_OPA=" + NCPSF_TRNSFR_OPA
				+ ", NCPSF_TRNSFR_TPA=" + NCPSF_TRNSFR_TPA + ", NCPSF_SF_S_N="
				+ NCPSF_SF_S_N + ", NCPSF_SF_S_IMPRD=" + NCPSF_SF_S_IMPRD
				+ ", NCPSF_SF_S_BLND=" + NCPSF_SF_S_BLND + ", NCPSF_SF_H_N="
				+ NCPSF_SF_H_N + ", NCPSF_SF_H_IMPRD=" + NCPSF_SF_H_IMPRD
				+ ", NCPSF_SF_H_DF=" + NCPSF_SF_H_DF + ", NCPSF_DEV_WC="
				+ NCPSF_DEV_WC + ", NCPSF_DEV_WLKR=" + NCPSF_DEV_WLKR
				+ ", NCPSF_DEV_C=" + NCPSF_DEV_C + ", NCPSF_DEV_CRTCHS="
				+ NCPSF_DEV_CRTCHS + ", NCPSF_DEV_PROS=" + NCPSF_DEV_PROS
				+ ", NCPSF_DEV_GLSES=" + NCPSF_DEV_GLSES
				+ ", NCPSF_DEV_CNTCTS=" + NCPSF_DEV_CNTCTS + ", NCPSF_DEV_D="
				+ NCPSF_DEV_D + ", NCPSF_DEV_HAL_OR_R=" + NCPSF_DEV_HAL_OR_R
				+ ", NCPSF_C_CONTNENT=" + NCPSF_C_CONTNENT
				+ ", NCPSF_C_INCONTNENT=" + NCPSF_C_INCONTNENT
				+ ", NCPSF_C_CATHTR=" + NCPSF_C_CATHTR + ", NCPSF_C_CATHTR_DI="
				+ NCPSF_C_CATHTR_DI + ", NCPSF_C_RFC_R=" + NCPSF_C_RFC_R
				+ ", NCPSF_C_RFC_SP=" + NCPSF_C_RFC_SP + ", NCPSF_C_RFC_OTHR="
				+ NCPSF_C_RFC_OTHR + ", NCPSF_C_RFC_OTHR_SPFY="
				+ NCPSF_C_RFC_OTHR_SPFY + ", NCPSF_C_BOWLINCONTNENT="
				+ NCPSF_C_BOWLINCONTNENT + ", NCPSF_C_OSTMY=" + NCPSF_C_OSTMY
				+ ", NCPSF_C_DOLBM=" + NCPSF_C_DOLBM + ", NCPSF_C_DOLB="
				+ NCPSF_C_DOLB + ", NCPSF_N_AND_H_D=" + NCPSF_N_AND_H_D
				+ ", NCPSF_N_AND_H_C=" + NCPSF_N_AND_H_C
				+ ", NCPSF_N_AND_H_FWR=" + NCPSF_N_AND_H_FWR
				+ ", NCPSF_N_AND_H_EI_SLF=" + NCPSF_N_AND_H_EI_SLF
				+ ", NCPSF_N_AND_H_EI_WA=" + NCPSF_N_AND_H_EI_WA
				...
				+ ", NCPSF_N_AND_H_TF_DIT=" + NCPSF_N_AND_H_TF_DIT
				+ ", NCPSF_N_AND_H_TF_DI_FWB_CC=" + NCPSF_N_AND_H_TF_DI_FWB_CC
				+ ", NCPSF_N_AND_H_TF_DI_FWB_HRS="
				+ NCPSF_N_AND_H_TF_DI_FWB_HRS + ", NCPSF_N_AND_H_TF_TFP="
				+ NCPSF_N_AND_H_TF_TFP + ", NCPSF_N_AND_H_TF_TFP_T="
				+ NCPSF_N_AND_H_TF_TFP_T
				+ ", NCPSF_N_AND_H_TF_TFP_RTE_CC_PER_H="
				+ NCPSF_N_AND_H_TF_TFP_RTE_CC_PER_H
				+ ", NCPSF_N_AND_H_TF_TFP_EVERY_H_OR_DAY="
				+ NCPSF_N_AND_H_TF_TFP_EVERY_H_OR_DAY + ", NCPSF_TTD_PICC="
				+ NCPSF_TTD_PICC + ", NCPSF_TTD_PRTCTH=" + NCPSF_TTD_PRTCTH
				+ ", NCPSF_TTD_PRTCTH_DI=" + NCPSF_TTD_PRTCTH_DI
				+ ", NCPSF_TTD_C_PM=" + NCPSF_TTD_C_PM + ", NCPSF_TTD_C_ICD="
				+ NCPSF_TTD_C_ICD + ", NCPSF_TTD_C_OTHR=" + NCPSF_TTD_C_OTHR
				+ ", NCPSF_TTD_C_OTHR_TEXT=" + NCPSF_TTD_C_OTHR_TEXT
				+ ", NCPSF_TTD_R_CPAP=" + NCPSF_TTD_R_CPAP
				+ ", NCPSF_TTD_R_BIPAP=" + NCPSF_TTD_R_BIPAP
				+ ", NCPSF_TTD_R_O2=" + NCPSF_TTD_R_O2
				...
				+ ", NCPSF_TTD_R_TS=" + NCPSF_TTD_R_TS
				+ ", NCPSF_TTD_R_TS_TEXT=" + NCPSF_TTD_R_TS_TEXT
				+ ", NCPSF_THRPS_PT=" + NCPSF_THRPS_PT + ", NCPSF_THRPS_OT="
				+ NCPSF_THRPS_OT + ", NCPSF_THRPS_S=" + NCPSF_THRPS_S
				+ ", NCPSF_THRPS_R=" + NCPSF_THRPS_R + ", NCPSF_THRPS_D="
				+ NCPSF_THRPS_D + ", NCPSF_SC_NSB=" + NCPSF_SC_NSB
				+ ", NCPSF_SC_PU=" + NCPSF_SC_PU + ", NCPSF_SC_PU_STAGE="
				+ NCPSF_SC_PU_STAGE + ", NCPSF_SC_PU_LOCATION="
				+ NCPSF_SC_PU_LOCATION + ", NCPSF_SC_SPU=" + NCPSF_SC_SPU
				+ ", NCPSF_SC_SPU_STAGE=" + NCPSF_SC_SPU_STAGE
				+ ", NCPSF_SC_SPU_LOCATION=" + NCPSF_SC_SPU_LOCATION
				+ ", NCPSF_SC_OTHR=" + NCPSF_SC_OTHR + ", NCPSF_SC_OTHR_SPCFY="
				+ NCPSF_SC_OTHR_SPCFY + ", NCPSF_R_AND_P_FALL="
				+ NCPSF_R_AND_P_FALL + ", NCPSF_R_AND_P_DELRUM="
				+ NCPSF_R_AND_P_DELRUM + ", NCPSF_R_AND_P_AGTATN="
				+ NCPSF_R_AND_P_AGTATN + ", NCPSF_R_AND_P_AGGRSN="
				+ NCPSF_R_AND_P_AGGRSN + ", NCPSF_R_AND_P_UEE="
				+ NCPSF_R_AND_P_UEE + ", NCPSF_R_AND_P_ASPRTN="
				+ NCPSF_R_AND_P_ASPRTN + ", NCPSF_R_AND_P_OTHR="
				+ NCPSF_R_AND_P_OTHR + ", NCPSF_R_AND_P_OTHR_TEXT="
				+ NCPSF_R_AND_P_OTHR_TEXT
				+ ", NCPSF_R_AND_P_OTHER_PRECAUTIONS="
				+ NCPSF_R_AND_P_OTHER_PRECAUTIONS + ", NCPSF_ICI_I_OR_C_MRSA="
				+ NCPSF_ICI_I_OR_C_MRSA + ", NCPSF_ICI_I_OR_C_VRE="
				+ NCPSF_ICI_I_OR_C_VRE + ", NCPSF_ICI_I_OR_C_CDI="
				+ NCPSF_ICI_I_OR_C_CDI + ", NCPSF_ICI_I_OR_C_ESBL="
				+ NCPSF_ICI_I_OR_C_ESBL + ", NCPSF_ICI_I_OR_C_NV="
				+ NCPSF_ICI_I_OR_C_NV + ", NCPSF_ICI_I_OR_C_F_OR_R="
				+ NCPSF_ICI_I_OR_C_F_OR_R + ", NCPSF_ICI_IP_NONE="
				+ NCPSF_ICI_IP_NONE + ", NCPSF_ICI_IP_CNTCT="
				+ NCPSF_ICI_IP_CNTCT + ", NCPSF_ICI_IP_CNTCTPLUS="
				+ NCPSF_ICI_IP_CNTCTPLUS + ", NCPSF_ICI_IP_DRPLT="
				+ NCPSF_ICI_IP_DRPLT + ", NCPSF_ICI_IP_ARBRNE="
				+ NCPSF_ICI_IP_ARBRNE + ", NCPSF_ICI_I_INFLUNZA="
				+ NCPSF_ICI_I_INFLUNZA + ", NCPSF_ICI_I_NO=" + NCPSF_ICI_I_NO
				+ ", NCPSF_ICI_I_Y=" + NCPSF_ICI_I_Y + ", NCPSF_ICI_I_YES_DTE="
				+ NCPSF_ICI_I_YES_DTE + ", NCPSF_ICI_I_P=" + NCPSF_ICI_I_P
				+ ", NCPSF_ICI_I_P_NO=" + NCPSF_ICI_I_P_NO
				+ ", NCPSF_ICI_I_P_YES=" + NCPSF_ICI_I_P_YES
				+ ", NCPSF_ICI_I_P_YES_DTE=" + NCPSF_ICI_I_P_YES_DTE
				+ ", MADAN_ADM_HP=" + MADAN_ADM_HP + ", MADAN_SP_CNS="
				+ MADAN_SP_CNS + ", MADAN_MED_RC=" + MADAN_MED_RC
				+ ", MADAN_OP_REP=" + MADAN_OP_REP + ", MADAN_DIAG_STUD="
				+ MADAN_DIAG_STUD + ", MADAN_LABS=" + MADAN_LABS
				+ ", MADAN_DIB_GLU_VAL=" + MADAN_DIB_GLU_VAL
				+ ", MADAN_PIC_PLS_CONF=" + MADAN_PIC_PLS_CONF
				+ ", MADAN_REB_THY_NOTS=" + MADAN_REB_THY_NOTS
				+ ", MADAN_REPO_THY_NOTS=" + MADAN_REPO_THY_NOTS
				+ ", MADAN_NUT_NOTS=" + MADAN_NUT_NOTS + ", MADAN_PAIN_RAT="
				+ MADAN_PAIN_RAT + ", MADAN_CDE_STS=" + MADAN_CDE_STS
				+ ", MADAN_AD_DIR=" + MADAN_AD_DIR + ", MADAN_DIS_SUM="
				+ MADAN_DIS_SUM + ", medicalReconciliationDto="
				+ medicalReconciliationDto + "]";
	}
