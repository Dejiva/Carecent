...
public class AdmissionFormResponse {
	...
	public AdmissionFormResponse(AdmissionDto formDto) {
		...
		this.doj = formDto.getDoj();
		this.sSNumber = formDto.getsSNumber();
		...
		this.nurseToNurseVerbalReportText = formDto.getNurseToNurseVerbalReport();
		this.nurseToNurseVerbalReport = formDto
		...
		this.stopAndWatchEligibility = formDto.getStopAndWatchEligibility();
		...
		this.hsptlPhyCareTeam = formDto.getHsptlPhyCareTeam();
		this.medicalReconList = formDto.getMedicalReconList();
		this.roomNumber=formDto.getRoomNumber();
		this.fromHospitalDischargeDate=formDto.getFromHospitalDischargeDate();
		this.status = formDto.getStatus();
	}
