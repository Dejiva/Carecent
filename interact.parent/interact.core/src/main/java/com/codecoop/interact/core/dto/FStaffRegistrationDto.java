...
public class FStaffRegistrationDto implements Serializable {
	...
	public FStaffRegistrationDto() {
	}

	public FStaffRegistrationDto(String firstName, String lastName,
			String middleName, String userName,
			Long staffRoleId, String empId, String gender,
			...
			Boolean primaryFlag, String user,
			Date date,Long facilityId, Long staffId,boolean deactive,Long docRoleId) {
		super();
